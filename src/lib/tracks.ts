...
export const tracks: Track[] = [
  {
    ...
    lessons: [
      ...
      { slug: "09-raii-and-ownership", title: "RAII, ownership, and why C++ is different", minutes: 35 },
      { slug: "10-smart-pointers", title: "unique_ptr, shared_ptr, weak_ptr", minutes: 30 },
      { slug: "11-move-semantics", title: "Move semantics and rvalue references", minutes: 40 },
      { slug: "12-templates", title: "Templates: generic programming from scratch", minutes: 45 },
      { slug: "13-stl-containers", title: "STL containers: vector, map, unordered_map, set", minutes: 40 },
      { slug: "14-stl-algorithms", title: "STL algorithms and iterators", minutes: 35 },
      { slug: "15-lambdas", title: "Lambdas, std::function, and closures", minutes: 25 },
      { slug: "16-error-handling", title: "Exceptions, std::expected, and error design", minutes: 30 },
      { slug: "17-concurrency", title: "Threads, mutexes, atomics, and memory order", minutes: 50 },
      { slug: "18-filesystem-and-io", title: "Files, streams, and <filesystem>", minutes: 25 },
      { slug: "19-networking-basics", title: "Sockets, TCP, UDP — the raw API", minutes: 45 },
      { slug: "20-testing-and-tooling", title: "Testing, sanitizers, profilers, debuggers", minutes: 35 }
    ]
  },
